...
overall <- readRDS('/n/groups/patel/akshaya/01_ukb/src/demos_dxa_exposures.rds')
...
exposure_names  <- names(overall)[104:ncol(overall)]
...
write.csv(results_list, file=paste('/n/groups/patel/akshaya/01_ukb/out/slurm_exposome_assoc/batch_exposome_', adiposity_col), row.names = FALSE)
